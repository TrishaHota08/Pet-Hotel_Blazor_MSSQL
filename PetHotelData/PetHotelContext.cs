    ...
    public class PetHotelContext : DbContext, IPetHotelContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            /* var ownerList = new Owner[]
                  {
                      new Owner{},
                      new Owner{ownerId=2,ownerName="Wiiliam", ownerEmail="william567@gmail.com", ownerPhone="67658978"},
                      new Owner{ownerId=3,ownerName="Alex", ownerEmail="alwex@gmail.com", ownerPhone="7677868"}
                  };*/

            //modelBuilder.Entity<Owner>().HasData(ownerList);
